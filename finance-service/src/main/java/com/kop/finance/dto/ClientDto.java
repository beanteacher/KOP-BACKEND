...
public class ClientDto {
    ...
    public record Response(
        ...
        String contactName, String contactPhone, String status, Instant createdAt
    ) {
        public static Response from(Client c) {
            return new Response(
                ...
                c.getContactName(), c.getContactPhone(), c.getStatus().name(), c.getCreatedAt()
            );
        }
    }

    public record ListItem(String id, String businessRegistrationNumber, String name, String representativeName, String status) {
        public static ListItem from(Client c) {
            return new ListItem(
                c.getId().toString(), c.getBusinessRegistrationNumber(), c.getName(), c.getRepresentativeName(), c.getStatus().name()
            );
        }
    }
}
